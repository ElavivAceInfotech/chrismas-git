...
<script src="{{ URL::to('public/adminlte/js') }}/bootstrap.min.js"></script>
<script src="{{ URL::to('public/adminlte/js') }}/select2.full.min.js"></script>
<script src="{{ URL::to('public/adminlte/js') }}/main.js"></script>

<script src="{{ URL::to('public/adminlte/plugins/slimScroll/jquery.slimscroll.min.js') }}"></script>
<script src="{{ URL::to('public/adminlte/plugins/fastclick/fastclick.js') }}"></script>
<script src="{{ URL::to('public/adminlte/js/app.min.js') }}"></script>
<script>
