  ...
  <body>
    ...
    <header class="masthead text-center text-white">
      <div class="masthead-content">
        <div class="container">
          <h1 class="masthead-heading mb-0">Happy holidays</h1>
          <h2 class="masthead-subheading mb-0">Spread good cheer across the globe!</h2>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 order-lg-2">
            <div class="p-5">
              <img class="img-fluid rounded-circle" src="{{ URL::to('public/thumb/01.jpg') }}" alt="">
            </div>
          </div>
          <div class="col-lg-6 order-lg-1">
            <div class="p-5">
              <h2 class="display-4">How your gift makes an impact</h2>
    ...
    <section>
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="p-5">
              <img class="img-fluid rounded-circle" src="{{ URL::to('public/thumb/02.jpg') }}" alt="">
            </div>
          </div>
          <div class="col-lg-6">
            <div class="p-5">
    ...
    <section>
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 order-lg-2">
            <div class="p-5">
              <img class="img-fluid rounded-circle" src="{{ URL::to('public/thumb/03.jpg') }}" alt="">
            </div>
          </div>
          <div class="col-lg-6 order-lg-1">
            <div class="p-5">
