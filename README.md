...
###We can use REST API using Passport provider
...
C:\xampp\htdocs\laravel-auth>php artisan passport:install
Encryption keys generated successfully.
Personal access client created successfully.
Client ID: 1
Client Secret: WRIIH7zRSIMbHWfQQElWJ8hW8fs5mOj65fZTnKco
Password grant client created successfully.
Client ID: 2
Client Secret: b7qGocnj9pfI7uGVMBJKoupQtUY7B4XeGturszYW